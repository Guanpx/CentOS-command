...
replace
:s/sbin/aa1712 查找光标所在行的第一个sbin并替换为aa1712
:s/sbin/aa1712/g 查找光标所在行的所有sbin并替换为aa1712
:%s/sbin/aa1712/g 查找文件中所有的sbin并替换为aa1712
:5,%s/sbin/aa1712/g 查找文件中从第五行开始所有的sbin并替换为aa1712
#块模式
v 进入字符选择模式
shift + v 进入行选择模式
ctrl + v 块选择模式
